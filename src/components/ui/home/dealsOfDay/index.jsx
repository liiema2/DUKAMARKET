                            ...
                            <div className="swiper-wrapper" >
                                ...
                                <div className="product__item swiper-slide w-25 ">
                                    ...
                                    <div className="product__content">
                                        ...
                                        <div className="progress mb-5">
                                            <div className="progress-bar bg-danger" role="progressbar" style={{width:"20%"}} aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <div className="progress-rate">
                                ...
                                <div className="product__item swiper-slide w-25">
                                    ...
                                    <div className="product__content">
                                        ...
                                        <div className="progress mb-5">
                                            <div className="progress-bar bg-danger" role="progressbar" style={{width:"35%"}} aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <div className="progress-rate">
